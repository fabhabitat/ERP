...
class Picking(models.Model):
    ...
    packing_list_bool=fields.Boolean('Packing List')
    invoice_bool=fields.Boolean('Invoice Bool')
    ship_label_bool=fields.Boolean('Shipping Label')
    pick_list_print_bool = fields.Boolean("Pick List Print")
    packing_list_print_bool = fields.Boolean("Packing List Print")
    invoice_print_bool = fields.Boolean("Invoice Print")
    shipping_label_print_bool = fields.Boolean("Label Print")
...
#     shipping_weight = fields.Char('Shipping Weight')
    shipper_package_code = fields.Char('Ship Package Code')
...
#     address fields
    ...
    def api_xmlrpc_create_record(self,vals):  
        ...
        shipping_weight = str(vals.get('shipping_weight', ''))
        invoice_required = vals.get('invoice_required', '')
        packing_list_required = vals.get('packing_list_required', '')
        shipper_package_code = str(vals.get('shipper_package_code', ''))
        ...
        if ship_to_name:
            ...
            if  res_partner_id and location_id and picking_type_id:
                ...
                do_id = self.sudo().env['stock.picking'].create({
                                           ...
                                           'shipper_package_code':shipper_package_code,
                                           'invoice_required':invoice_required,
                                           'packing_list_required':packing_list_required,
